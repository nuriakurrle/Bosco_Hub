// app/inquiry/[id]/page.js — Detalle de una anfrage.
// Si la inquiry pertenece a una conversación con varias reservas, mostramos
// SplitDetail; si no, Detail.
...
export default async function InquiryPage({ params }) {
  ...
  // ¿Hay hermanas en la misma conversación?
  let siblings = [item];
