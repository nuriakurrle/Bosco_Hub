...
function rowToBooking(row) {
  ...
  return {
    ...
    // Anforderungen aus der Quell-Anfrage → fließen in den Küchenplan
    // (Verpflegungsart, Vegetarisch/Vegan/Allergien).
...
export async function getBookings() {
  const rows = await query(
    `SELECT b.*, h.name AS house_name, i.school_name, i.special_requirements
       FROM bookings b
